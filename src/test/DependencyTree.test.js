...
describe('DependencyTree', function () {
    ...
    describe('new DependencyTree()', function () {
        it('create DependencyTree instance with no arg', function () {
        ...
        it('create DependencyTree instance with valid baseNode', function () {
    ...
    describe('DependencyTree.getDepsByHeight()', function () {
        it('getDepsByHeight() without argument will throw an error', function () {
        ...
        it('getDepsByHeight(-1) will throw an error', function () {
            const classTree = new DependencyTree(DependencyTreeFixture.baseNode);
        ...
        it(`getDepsByHeight(0) returns base node (with name = '${DependencyTreeFixture.baseNode.name}') of deps tree`, function () {
            const classTree = new DependencyTree(DependencyTreeFixture.baseNode);
    ...
    describe('DependencyTree.groupByHeight()', function () {
        it(`getDepsByHeight(0) returns base node (with name = '${DependencyTreeFixture.baseNode.name}') of deps tree`, function () {
            const classTree = new DependencyTree(DependencyTreeFixture.baseNode);
