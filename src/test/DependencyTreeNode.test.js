...
describe('DependencyTreeNode', function () {
    describe('new DependencyTreeNode()', function () {
        it('create DependencyTreeNode without arguments will throw an error', function () {
        ...
        it("create DependencyTreeNode with 'height' that's not a number will throw an error", function () {
        ...
        it("create DependencyTreeNode with 'deps' that's an array of not DependencyTreeNode instances will throw an error", function () {
        ...
        it("DependencyTreeNode with valid arguments should set it's own properties correctly", function () {
            const baseNode = new DependencyTreeNode(DependencyTreeFixture.baseClazz, 0, [new DependencyTreeNode(DependencyTreeFixture.derivedClazz, 1, [])]);
